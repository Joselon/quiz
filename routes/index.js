...
router.get('/quizes/:quizId(\\d+)/ahorcado', quizController.ahorcado);
...
router.post('/quizes/:quizId(\\d+)/comments/:commentId(\\d+)/update', sessionController.loginRequired, commentController.update);
